package tech.zamankazimov.stack;
...
public class LocalStack extends Stack {
    ...
    private void createGatewayService() {
        FargateTaskDefinition taskDefinition = FargateTaskDefinition.Builder
                .create(this, "GatewayTaskDefinition")
                .cpu(256)
                .memoryLimitMiB(512)
                .build();
        ...
        ContainerDefinitionOptions containerOptions = ContainerDefinitionOptions.builder()
                ...
                .portMappings(List.of(4004).stream()
                        ...
                        .toList())
                .logging(LogDriver.awsLogs(AwsLogDriverProps.builder()
                        .logGroup(LogGroup.Builder.create(this, "GatewayLogGroup")
        ...
        taskDefinition.addContainer("GatewayContainer", containerOptions);

        ApplicationLoadBalancedFargateService gateway = ApplicationLoadBalancedFargateService.Builder
                .create(this, "GatewayService")
                .cluster(ecsCluster)
                .serviceName("gateway")
                .taskDefinition(taskDefinition)
                .desiredCount(1)
